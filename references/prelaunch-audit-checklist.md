...
## Step 1: AI Compliance Audit
- [ ] Ask your AI coding assistant (configured with `.airules`) to audit your Android project:
  ```
  audit my Android project for compliance
  ```
- [ ] Review the compliance report generated by your AI assistant and resolve any identified violations.

---

## Step 2: Security and Storage Checks
...
## Step 3: Permissions and Features
...
## Step 4: Legal and Policy Disclosures
...
## Step 5: Global Minor and Accessibility Checks
