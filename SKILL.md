...
| You serve EU consumers | European Accessibility Act — WCAG 2.1 AA / EN 301 549 is the technical bar. Solo devs/micro-enterprises (<10 employees, <2M EUR turnover) are currently exempt, but build accessible by default since exemption ends the moment you scale | `references/children-accessibility.md` |
